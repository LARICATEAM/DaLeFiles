...
if DevAbs:get(DaLe.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(DaLe.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(DaLe.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(DaLe.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(DaLe.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(DaLe.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
DaLeName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if DaLeName then 
DaLeNames = DevAbs:smembers(DaLe.."Abs:Mute:Names"..msg.chat_id_) or ""
if DaLeNames and DaLeNames[1] then 
for i=1,#DaLeNames do 
if DaLeName:match("(.*)("..DaLeNames[i]..")(.*)") then 
...
DevAbs:set(DaLe.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(DaLe.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
